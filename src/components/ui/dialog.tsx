  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed left-[50%] top-[50%] z-[101] grid w-full max-w-[calc(100%-1rem)] -translate-x-[50%] -translate-y-[50%] gap-3 rounded-xl border bg-background p-4 shadow-2xl duration-150 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 sm:max-w-md",
          className
        )}
        {...props}
      >
